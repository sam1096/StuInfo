        ...
        <table class="center" style="text-align:left;">
            ...
            <tr>
                ...
                <td class="auto-style1">
                    <asp:TextBox ID="lol" runat="server" Width="239px" class="input" placeholder="Enrollment Number"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class="auto-style5">
                    <asp:TextBox ID="email" runat="server" Width="239px" class="input" placeholder="Email ID" style="margin-bottom: 5px"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="auto-style5">
                    <asp:TextBox ID="dob" runat="server" Width="239px" class="input"></asp:TextBox>
                </td>
                </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="auto-style5">
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Submit" Width="86px" class="loginbutton" style="margin-left: 88px"/>
                    </td>
                <td>
                    <input id="Reset1" type="reset" value="Reset" class="loginbutton" style="width:86px;"/></td>
            </tr>
