...
public partial class adminlogin : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
       /* String user = Session["LogUser"].ToString();
        ...
        if (user == "student")
        {
            Response.Write("You were logged in as student. Logging you out!");
            Session.Abandon();
        }*/
    }
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        conn.Open();
        String check = "select count(*) from Admin where adname='" + adname.Text+ "'";
        ...
        if (tem == 1)
        {
            string checkpass = "select adpass from Admin where adname ='" + adname.Text+ "'";
